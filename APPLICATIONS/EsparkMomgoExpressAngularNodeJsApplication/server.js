...
// {go to the application dir and issue the cmd} npm install express --save
var express = require('express');
var app = express();

// {go to the application dir and issue the cmd} npm install body-parser --save
var bodyParser = require('body-parser');
app.use(bodyParser.json());

// {go to the application dir and issue the cmd} npm install mongojs --save
    ...
    db.user.findOne({$and: [
        ...
        if (error) {
            ...
            if (docs != null && username == docs.username && password == docs.password) {
                ...
                logger.warn('login credential not match');
                response.json(false);
            }
        }
    });
